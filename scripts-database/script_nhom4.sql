...
GRANT ANY PRIVILEGE TO QLBENHVIEN WITH ADMIN OPTION;
GRANT EXEMPT ACCESS POLICY TO QLBENHVIEN;
GRANT ALTER SYSTEM TO QLBENHVIEN;
GRANT ALTER DATABASE TO QLBENHVIEN;
GRANT FLASHBACK ANY TABLE TO QLBENHVIEN WITH ADMIN OPTION;
...
BEGIN
    ...
    IF v_user LIKE 'BS%' THEN
        RETURN 'MAHSBA IN (SELECT MAHSBA FROM HSBA WHERE MABS = ''' || v_user || ''')';
...
--------------------------------------------------
-- FUNCTION TRÊN BẢNG DONTHUOC
--------------------------------------------------

CREATE OR REPLACE FUNCTION BS_DONTHUOC (
    P_SCHEMA VARCHAR2,
    P_OBJECT VARCHAR2
)
RETURN VARCHAR2
